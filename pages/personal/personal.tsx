...
import img_webpub_2_1 from "../../public/webpub_2_1.png";
import img_webpub_2_2 from "../../public/webpub_2_2.png";
  ...
  return (
    <div className={styles.main}>
      ...
      <div>
        <div className={styles.title}>
          {" "}
          <a href="./project3/home">Web Publishing-1</a>
        </div>
        <p className={styles.content}>[html+css+js] 스타벅스 FW21 사이트</p>
      ...
      <div>
        <div className={styles.title}>
          {" "}
          <a href="https://git2022-webpublishing-1.vercel.app/">
            Web Publishing-2
          </a>
        </div>
        <p className={styles.content}>[html+css] 패션 매거진 반응형 사이트</p>
        <img className={styles.img} src={img_webpub_2_1.src} />
      </div>
      {/* 진행중 */}
      <div className={styles.subTitle}>현 진행상황</div>
      <p className={styles.content}>- 서브메뉴 페이지 구상 중</p>
      <img
        style={{
          width: "auto",
          height: "250px",
